...
if (!file.exists("RD1-roi_polygons_with_edges.RData")) {
    save(roi_all_sf_polygon, file = "RD1-roi_polygons_with_edges.RData")
}
...
ggsave("../HuBMAP_Updates/Cell Type Assignment.tiff", device = "tiff", dpi = 300, width = 1570, height = 1100, units = "px")
